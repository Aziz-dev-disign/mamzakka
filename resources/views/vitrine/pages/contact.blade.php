@extends('vitrine.layouts.accueil')
            ...
            <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <div class="form-group">
                        <input type="text" name="name" class="form-control form-control-lg form-control-a" placeholder="Nom" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              ...
              <div class="col-md-5 section-md-t3">
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    <div class="icon-box-title">
                      <h4 class="icon-title">Dites Salut</h4>
                    </div>
                    <div class="icon-box-content">
                      <p class="mb-1">Email.
                        <span class="color-a">contact@mamzakka.com</span>
                      </p>
                      <p class="mb-1">Téléphone.
                        <span class="color-a">(00226)70 18 08 74/55 99 56 26 </span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    <div class="icon-box-title">
                      <h4 class="icon-title">Retrouver nous sur</h4>
                    </div>
                    <div class="icon-box-content">
                      <p class="mb-1">
                        Hamdallaye, Rue 10.74,
                        <br> Port, 135
                      </p>
                    </div>
                  </div>
